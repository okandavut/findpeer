...
export default function Add() {
    ...
    return (
        <>
            <Container>
                <>
                    <h3 style={{ marginTop: "21px" }} className='new-peer-title'>Add New Peer</h3>
                    <hr />
                    {loading ? (
                        ...
                        <>
                            ...
                            <Form>
                                <Form.Group controlId="exampleForm.ControlInput1">
                                    <Form.Label className='lbl-new-peer'>Superpeer Username</Form.Label>
                                    <Form.Control
                                        type="text"
                                ...
                                <Form.Group controlId="exampleForm.ControlSelect2" className='new-peer-category'>
                                    <Form.Label>
                                ...
                                <Form.Group controlId="exampleForm.ControlSelect2">
                                    <Button variant="success" onClick={addNewPeer} style={{marginRight: 10}}>
                                        Add
                                    </Button>
                                    <Link href={"/"}>
